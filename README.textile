...
If everything works, you're ready to start customizing Indie with your own endpoints and traversals.
...
Gremlin is built on Groovy and so can also act as a REPL. A script to start Gremlin is included with the server
distribution.
