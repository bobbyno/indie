...
to your production server. Developers needing only a jar containing their libraries can create an Ant target to create
that behavior.
...
org.neo4j.server.thirdparty_jaxrs_classes=com.aurelius.indie.resources=/ext</code></pre>
